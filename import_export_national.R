...
if (!file.exists("./201503-stat-national-ce-import.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150519-152247/201503-stat-national-ce-import.zip","./201503-stat-national-ce-import.zip")
}
unzip("./201503-stat-national-ce-import.zip", exdir = "2015I")

#Exports 2015
if (!file.exists("./201503-stat-national-ce-export.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150519-151607/201503-stat-national-ce-export.zip","./201503-stat-national-ce-export.zip")
}
unzip("./201503-stat-national-ce-export.zip", exdir = "2015E")

#Imports 2014
if (!file.exists("./201501-stat-national-ce-import.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150519-150221/201501-stat-national-ce-import.zip","201501-stat-national-ce-import.zip")
}
unzip("./201501-stat-national-ce-import.zip", exdir = "2014I") 

#Exports 2014
if (!file.exists("./201501-stat-national-ce-export.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150519-145744/201501-stat-national-ce-export.zip","201501-stat-national-ce-export.zip")
}
unzip("./201501-stat-national-ce-export.zip", exdir = "2014E")

#Imports 2013
if (!file.exists("./2013-stat-national-ce-import.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150518-163554/2013-stat-national-ce-import.zip","./2013-stat-national-ce-import.zip")
}
unzip("./2013-stat-national-ce-import.zip", exdir = "2013I")

#Exports 2013
if (!file.exists("./2013-stat-national-ce-export.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150518-164559/2013-stat-national-ce-export.zip","./2013-stat-national-ce-export.zip")
}
...
if (!file.exists("./2012-stat-national-ce-export.zip")){
  download.file("http://www.data.gouv.fr/s/resources/statistiques-nationales-du-commerce-exterieur-1/20150518-163235/2012-stat-national-ce-export.zip","./2012-stat-national-ce-export.zip")
}
...
sum <-aggregate(value ~ year + flow, national, sum)
